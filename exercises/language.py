...
#        print "item = ", current_item
        ...
        current_index = current_item[2]
        for letter in test_word[current_index]:
#            print "letter = ", letter
            if letter in current_node.children:
...
#                print "new_word = ", new_word
                if "".join(new_word) in word_dict:
                    ...
                    queue.append([new_word,current_node.children[letter],len(new_word)])
